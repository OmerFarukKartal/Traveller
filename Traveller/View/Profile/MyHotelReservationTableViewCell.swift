...
class MyHotelReservationTableViewCell: UITableViewCell {
    
    var containerView = UIView()
    var hotelRoomImage = UIImageView()
    var priceLabel = UILabel()
    var roomTypeLabel = UILabel()
    var girisTarihiLabel = UILabel()
    var cikisTarihiLabel = UILabel()
    ...
    func setupUI() {
        ...
        containerView.addSubview(girisTarihiLabel)
        girisTarihiLabel.translatesAutoresizingMaskIntoConstraints = false
        girisTarihiLabel.anchor(top: containerView.topAnchor, left: hotelRoomImage.rightAnchor, paddingTop: 10, paddingLeft: 10)
        containerView.addSubview(cikisTarihiLabel)
        cikisTarihiLabel.translatesAutoresizingMaskIntoConstraints = false
        cikisTarihiLabel.anchor(top: girisTarihiLabel.bottomAnchor, left: hotelRoomImage.rightAnchor, paddingTop: 10, paddingLeft: 10)
        containerView.addSubview(nameLabel)
        nameLabel.translatesAutoresizingMaskIntoConstraints = false
        nameLabel.anchor(top: cikisTarihiLabel.bottomAnchor, left: hotelRoomImage.rightAnchor, paddingTop: 10, paddingLeft: 10)
    }
